                  ...
                  <form action="reRegister?buyNo=${buy.buyNo }" method="post">
                     <div class="select-list">
                        <div class="register-row">
                           <p>제목</p>
                           <input type="text" name="title" value="${buy.title }">
                        </div>
                        <div class="select-list-item">
                           <p>최소가격</p>
                           <input type="text" name="minPrice" onkeyup="inputComma(this);" value="${buy.minPrice }">
                        </div>
                        <div class="select-list-item">
                           <p>최대가격</p>
                           <input type="text" name="maxPrice" onkeyup="inputComma(this);" value="${buy.maxPrice }">
                        </div>
                        ...
                        <div class="register-row" id="region" style="display: none;">
                           <p>거래 지역</p>
                           <input type="text" name="region" id="sample4_jibunAddress" value="${buy.region }" style="float: left;"> 
						   <input type="button" onclick="sample4_execDaumPostcode()" value="지역 찾기" style="float: left;">
                        </div>
		                   <div class="select-list-item">
		                        <p>대분류</p>
		                            <input type="text" name="bigClassifier" readonly="readonly" value="의류" style="background-color: #dcdcdc;">
		                   </div>
		                   <div class="select-list-item">
		                        <p>중분류</p>
		                            <input type="text" name="mediumClassifier" readonly="readonly" value="상의" style="background-color: #dcdcdc;">
		                   </div>
                        <div class="register-row">
                           <p>키워드1</p>
                           <input type="text" name="keyword1" value="${buy.keyword1 }">
                        </div>
                        <div class="register-row">
                           <p>키워드2</p>
                           <input type="text" name="keyword2" value="${buy.keyword2 }">
                        </div>
                        <div class="register-row">
                           <p>키워드3</p>
                           <input type="text" name="keyword3" value="${buy.keyword3 }">
                        </div>
                     </div>
                     <div class="col-lg-5" style="float: left;margin-left: 50px;">
                     	<button type="submit" class="site-btn">구매 재등록</button>
                     </div>
                     <div class="col-lg-5" style="float: left;">
                     	<button type="button" class="site-btn" onclick="location.href='/buyBoard/list'">등록 취소</button>
                     </div>
                  </form>
               </div>
            </div>
