        ...
        <div class="container">
            ...
            <div class="col-lg-5 col-md-6">
               <div class="hero__tab__form">
                  ...
                  <input type="hidden" value="${sell.sellNo }" name="SellNo">
                     <div class="select-list">
                        <div class="register-row">
                           <p style="font-size: 20px">제품명</p>
                           <input type="text" value="${sell.itemName }" name="ItemName" placeholder="필수 입력 사항" style="width: 94%">
                        </div>
                        <div class="select-list-item">
                           <p style="font-size: 20px">가격</p>
                           <input type="text" value="${sell.price }" name="Price" placeholder="필수 입력 사항" style="width: 94%">
                        </div>
                        <div class="select-list-item">
                           <p style="font-size: 20px">제품 상태</p>
                           <select name="ItemCondition">
                           <c:if test="${sell.itemCondition == '상'}">
                           	  <option value="상" selected="selected">상</option>
                              <option value="중">중</option>
                              <option value="하">하</option>
                           </c:if>
                           <c:if test="${sell.itemCondition == '중'}">
                           	  <option value="상">상</option>
                              <option value="중" selected="selected">중</option>
                              <option value="하">하</option>
                           </c:if>
                           <c:if test="${sell.itemCondition == '하'}">
                           	  <option value="상">상</option>
                              <option value="중">중</option>
                        ...
                        <div class="register-row">
									...
									<c:if test="${sell.type == '직거래'}">
										<div>
										<input type="radio" name="Type" value="택배거래" style="float: left; width:10%; height: 23px;">
										<p style="float: left;">택배거래</p>
										<input type="radio" name="Type" value="직거래" checked="checked" style="float: left; width:10%; height: 23px; margin-left: 20px;">
										<p style="float: left;">직거래</p>
										<input type="radio" name="Type" value="택배거래/직거래" style="float: left; width:10%; height: 23px; margin-left: 20px;">
										<p style="float: left;">택배거래/직거래</p>
										</div>
									</c:if>
									<c:if test="${sell.type == '택배거래/직거래'}">
										<div>
										<input type="radio" name="Type" value="택배거래" style="float: left; width:10%; height: 23px;">
										<p style="float: left;">택배거래</p>
										<input type="radio" name="Type" value="직거래" style="float: left; width:10%; height: 23px; margin-left: 20px;">
										<p style="float: left;">직거래</p>
										<input type="radio" name="Type" value="택배거래/직거래" checked="checked" style="float: left; width:10%; height: 23px; margin-left: 20px;">
										<p style="float: left;">택배거래/직거래</p>
										</div>
									</c:if>
                        ...
                        <div class="select-list-item">
                           ...
                           <c:if test="${sell.mediumClassifier == '상의' }">
                           ...
                           <c:if test="${sell.mediumClassifier == '하의' }">
                           <select name="MediumClassifier" id="mediumClassifier">
                              <option value="상의">상의</option>
                              <option value="하의" selected="selected">하의</option>
                              <option value="악세사리">악세사리</option>
                              <option value="냉장고">냉장고</option>
                              <option value="에어컨">에어컨</option>
                              <option value="세탁기">세탁기</option>
                           ...
                           <c:if test="${sell.mediumClassifier == '악세사리' }">
                           <select name="MediumClassifier" id="mediumClassifier">
                              <option value="상의">상의</option>
                              <option value="하의">하의</option>
                           ...
                           <c:if test="${sell.mediumClassifier == '냉장고' }">
                           <select name="MediumClassifier" id="mediumClassifier">
                              <option value="상의">상의</option>
                              <option value="하의">하의</option>
                              <option value="악세사리">악세사리</option>
                           ...
                           <c:if test="${sell.mediumClassifier == '에어컨' }">
                           <select name="MediumClassifier" id="mediumClassifier">
                              <option value="상의">상의</option>
                              <option value="하의">하의</option>
                              <option value="악세사리">악세사리</option>
                              <option value="냉장고">냉장고</option>
                              <option value="에어컨" selected="selected">에어컨</option>
                              <option value="세탁기">세탁기</option>
                           </select>
                           </c:if>
                           <c:if test="${sell.mediumClassifier == '세탁기' }">
                           <select name="MediumClassifier" id="mediumClassifier">
                              <option value="상의">상의</option>
                              <option value="하의">하의</option>
                              <option value="악세사리">악세사리</option>
                              <option value="냉장고">냉장고</option>
                              <option value="에어컨">에어컨</option>
                              <option value="세탁기" selected="selected">세탁기</option>
                           </select>
                           </c:if>
                        ...
                        <div class="register-row">
                           <p>키워드1</p>
                           <input type="text" value="${sell.keyword1 }" name="Keyword1" style="width: 94%">
                        </div>
                        <div class="register-row">
                           <p>키워드2</p>
                           <input type="text" value="${sell.keyword2 }" name="Keyword2" style="width: 94%">
                        </div>
                        <div class="register-row">
                           <p>키워드3</p>
                           <input type="text" value="${sell.keyword3 }" name="Keyword3" style="width: 94%">
                        </div>
...
<script type="text/javascript">
	$(document).ready(function() {
		var picName = '<c:out value="${sell.picture}"/>';
		var array = picName.split(',');
		
		if (picName != "") {
			$('.about__pic').empty();
			for (var i = 0; i < array.length; i++) {
				var str = "<img src='/resources/img/upload/" + array[i] + "' onclick = 'imgClick()'>";
				$('.about__pic').append(str);
			}
		}
